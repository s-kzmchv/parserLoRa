        ...
        if n == 1:
            ...
            for item in np.arange(-timeOnAir, timeOnAir+1, part):
                ...
                if dict.get(item) != None:
                    ...
                    # Xi.append(str(item))
                    Xi.append(item)
                    print('Pr[success | ' + str(item) + '] = ' + str(PrCurr) + ' Success: ' + str(dict[item][0]) + ' Fail: ' + str(dict[item][1]))
                else:
                    Pr.append(0)
                    N_message.append(0)
                    # Xi.append(str(item))
...
#            plt.clf()
#
#            plt.plot(Xi, N_message, color="g", label='something')
#            plt.xlabel('Xi')
#            plt.ylabel('NumOfMessage')
#            plt.legend()
#            plt.savefig("n={} for message.png".format(n))
#            # plt.show()
#            plt.clf()
#
#
